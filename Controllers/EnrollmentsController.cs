...
namespace SchoolManagementApp.MVC.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(SchoolMgmtContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolMgmtContext = _context.Enrollments.Include(e => e.Class).Include(e => e.Student);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolMgmtContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
